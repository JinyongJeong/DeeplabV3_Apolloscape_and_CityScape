...
APOLLOSCAPE_ROOT="${WORK_DIR}/apolloscape"

# Create training labels.
#python "${APOLLOSCAPE_ROOT}/cityscapesscripts/preparation/createTrainIdLabelImgs.py"

# Build TFRecords of the dataset.
# First, create output directory for storing TFRecords.
OUTPUT_DIR="${APOLLOSCAPE_ROOT}/tfrecord"
mkdir -p "${OUTPUT_DIR}"

BUILD_SCRIPT="${CURRENT_DIR}/build_apolloscape_data.py"

echo "Converting Apolloscape dataset..."
python "${BUILD_SCRIPT}" \
  --apolloscape_root="${APOLLOSCAPE_ROOT}" \
